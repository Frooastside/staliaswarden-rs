...
So whenever I want to register to a new website, I just create a new email alias through Bitwarden and it just works.
...
- `FORWARD_TO` should be the main email all aliases will forward to.
- `STALWART_URL` is the domain (or IP) you host your stalwart instance on.
